angular.module('helios').controller('dashboardCtrl', function($scope, $ocLazyLoad) {
    ...
    $scope.$on('$viewContentLoaded', function(e, params) {
        console.debug('dashboardCtrl.viewContentLoaded');
    });
    $scope.hello = "你好, Helios";
